 ...
 */
class AthletesRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(Athletes $entity, bool $flush = false): void
    {
